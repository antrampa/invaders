...
#Intro Message
#
def GameIntroMessage(screen):
  font = pygame.font.SysFont("impact", 32)
  introtext = font.render("Ελλάδα 2209...",True,(255,255,255))
  text_x = CenterMessage(screen, introtext)
  screen.blit(introtext, (text_x,280))
  return
...
def main():
  ...
  screenwidth,screenheight = (480,640) #(600,1068) #(480,640)
  ...
  StarField = SpaceBackground(screenheight, "stars.jpg") #"stars.jpg" "bg1.jpg"
  shipimages = ('F-16-100.png', 'F-16-100-x.png')
  ...
  alienimage=('alien1.png','alien2.png','alien3.png','alien4.png','SU-24-100-enemy.png','Enemy-1.png')
